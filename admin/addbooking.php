                      ...
                      <div class="col-md-6">
                          <div class="col-md-12">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" list="costumers" id="costumer" name="costumer" required>
                  ...
                  <div class="row port-fields" id="port_fields_edit" style="display:none;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <div class="col-md-12">
                            <div class="mb-3">
                              <label for="costumer1" class="form-label">Costumer Name<span style="color: red;">*</span></label>
                              <input type="text" class="form-control" list="costumer1" id="costumer1" name="costumer1" required>
                              <datalist id="costumer1">
                                  <option value="ABC">
                                  <option value="CTH">
                                  <option value="DPC">
                                  <option value="DM">
