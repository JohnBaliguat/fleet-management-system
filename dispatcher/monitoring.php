            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-2">
                  ...
                  <input class="form-control" list="datalistOptions_destination_from" name="destination_from1" id="edit_destination_from" readonly>
                </div>

                <div class="col-md-6 mb-2">
                  <label class="form-label">To</label>
                  <input class="form-control" list="datalistOptions_destination_to" name="destination_to1" id="edit_destination_to" readonly>
                </div>
