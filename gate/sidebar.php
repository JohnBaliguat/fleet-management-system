    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="gate-dashboard" aria-expanded="false">
            <i class="ti ti-gauge"></i>
            <span class="hide-menu">Dashboard</span>
          </a>
        </li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="gate-checkin" aria-expanded="false">
            <i class="ti ti-qrcode"></i>
            <span class="hide-menu">Vehicle Check-In / Out</span>
          </a>
        </li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="gate-incident" aria-expanded="false">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="gate-profile" aria-expanded="false">
