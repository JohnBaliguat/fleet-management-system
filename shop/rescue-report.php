...
<head>
  ...
  <title>Rescue Unit Report</title>
            ...
            <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="filterForm" class="row g-3 align-items-center mb-3" method="POST" action="php/rescue-report.php" target="_blank" class="Excel">
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center">
                    <div>
                      <h4 class="card-title">List of Rescue Record</h4>
                    </div>
                  </div>
                  <!-- Body -->
  ...
  <script>
    $(document).ready(function () {
      let table = $('#table-data').DataTable({
        "ajax": "table-fetch/fetch_rescue_report.php",
        "columns": [
          { "data": "driver" },
          { "data": "unit" },
          { "data": "start" },
