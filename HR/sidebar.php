        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="hr-dashboard" aria-expanded="false">
                <i class="ti ti-layout-dashboard"></i>
                <span class="hide-menu">Dashboard</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="hr-drivers" aria-expanded="false">
                <i class="ti ti-users"></i>
                <span class="hide-menu">Drivers</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="hr-performance" aria-expanded="false">
                <i class="ti ti-chart-line fs-6"></i>
                <span class="hide-menu">Performance</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="hr-violationReport" aria-expanded="false">
                <i class="ti ti-clipboard"></i>
                <span class="hide-menu">Violation Report</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="hr-tripReport" aria-expanded="false">
                <i class="ti ti-report"></i>
                <span class="hide-menu">Trip Report</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="hr-attendReport" aria-expanded="false">
